                        ...
                        <ul class="nav navbar-nav mr-auto">
                            <li class="nav-item">
                                <a href="#" class="nav-link" data-toggle="dropdown">
                                    <span class="d-lg-none">Happening</span>
                                </a>
                            </li>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div style="background: #ffffff;padding: 20px;text-align: center;">
                                <h3 style="text-align: center;font-weight: bold;color: orange;">Upload New Happening Cause Information</h3>
                                <table>
                                    <form action="/minorProject/HappenChecker" method="POST" enctype="multipart/form-data">
                                        <tr>
                                            <td><label for="imgCause">Upload Cause Image</label></td>
                                            <td><input type='file' id="imgCause" name="imgCause" onchange="readImg(this);" accept="image/*" required/></td>
                                        </tr>
                                        <tr>
                                            <td><label for="causeTitle">Happening Cause Title</label></td>
                                            <td><input type="text" id="causeTitle" name="causeTitle" placeholder="Happening Cause Title..." maxlength="60" required></td>
                                        </tr>
                                        <tr>
                                            <td><img id="cause" src="" alt="your image" /></td>
                                            <td><input type="submit" value="Upload New Happening Cause"></td>
                                        </tr>
                                    </form>
                                </table>
                            </div><br/>
                            <div style="background: #ffffff;padding: 20px;text-align: center;">
                                <h3 style="text-align: center;font-weight: bold;color: rgb(255, 115, 1);">Upload New Events and Activity Info</h3>
                                <table>
                                    <form action="/minorProject/ActivityChecker" method="POST">
                                        <tr>
                                            <td><label for="events">Events and Activity Name</label></td>
                                            <td><input type="text" id="events" name="events" placeholder="Events and Activity Name..." maxlength="60" required></td>
                                        </tr>
                                        <tr>
                                            <td><label for="locate">Happening Cause Location</label></td>
                                            <td><input type="text" id="locate" name="locate" placeholder="Events and Activity Location..." maxlength="20" required></td>
                                        </tr>
                                        <tr>
                                            <td><label for="date">Happening Cause Date</label></td>
                                            <td><input type="date" id="date" name="eventOn" required></td>
                                        </tr>
                                        <tr>
                                            <td></td>
                                            <td><input type="submit" value="Upload New Happening Cause"></td>
