...
<body>
        <%
                    ...
                    if(name==null&type==null){
                        ...
                        //outs.println("location='ourCampaign/ourCampaign.jsp';");
                        outs.println("</script>");
    ...
    <section class="billing">
        <div class="row">
            <div class="container dc">
                <h2 style="text-align: center;padding-top: 15px;">Donate</h2>
            </div>
            <div class="col-75">
                <div class="container">

                    <form action="DonateCampChecker" method="POST" class="donorInfo">
                        ...
                        <div class="campAmt">
                            ...
                            <input type="number" id="amt" name="amt" min="50" placeholder="Enter Amount*..." required>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-50">
                                ...
                                <input type="text" id="country" name="country" placeholder="INDIA" readonly>
                    ...
                    <form action="DonateCampCheckerMultipart" method="POST" enctype="multipart/form-data" class="donorInfo" style="display: none;">
                        <br/>
                        <div class="campAmt">
                            <label for="amt">Enter Amount* </label>
                            <input type="number" id="amt" name="amt" min="50" placeholder="Enter Amount*..." required>
                        ...
                        <select name='returnFilling' id='return_nri' class="eeee" required> 
                    ...
                    <form action="DonateCampCheckerMultipart1" method="POST" enctype="multipart/form-data" class="donorInfo" style="display: none;">
                        <br/>
                        <div class="campAmt">
                            <label for="amt">Enter Amount* </label>
                            <input type="number" id="amt" name="amt" min="50" placeholder="Enter Amount*..." required>
